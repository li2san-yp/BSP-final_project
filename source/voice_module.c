...
unsigned char xdata voice_time_1[5] = {0, 10, 20, 22, 16};  

code unsigned char VOICE_STRING_1[5][200] = {
    {0},
...
void CheckCountdownEvent()
{
    ...
    if (rest_total_seconds == voice_time_1[station_id] && mode == 0 && station_id > 0 && station_id < 5)
    {
        // Uart2Print("111", sizeof("111"));
        Uart2Print(VOICE_STRING_1[station_id], sizeof(VOICE_STRING_1[station_id]));
    }
    else if (rest_total_seconds == 5 && mode == 1 && station_id > 0 && station_id < 5)
    {
        Uart2Print(VOICE_STRING_2, sizeof(VOICE_STRING_2));
    }
    /*
    else if (rest_total_seconds ==  && mode == 0)
    {
        Uart2Print("333", sizeof("333"));
